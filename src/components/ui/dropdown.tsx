...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.SubContent
    ref={ref}
    className={cn(
      "z-50 min-w-[10rem] overflow-hidden rounded-xl border border-[var(--border)] bg-[var(--surface)] p-1 text-[var(--text-primary)] shadow-lg",
...
>(({ className, children, ...props }, ref) => (
  <DropdownMenuPrimitive.RadioItem
    ...
    {...props}
  >
    <span className="absolute left-2 flex h-2 w-2 rounded-full bg-[var(--primary)]">
      <DropdownMenuPrimitive.ItemIndicator />
    </span>
    {children}
  </DropdownMenuPrimitive.RadioItem>
...
>(({ className, inset, ...props }, ref) => (
  <DropdownMenuPrimitive.Label
    ref={ref}
    className={cn(
      "px-3 py-2 text-sm font-semibold text-[var(--text-secondary)]",
      inset && "pl-8",
      className
    )}
    {...props}
